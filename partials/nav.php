...
<nav class="navbar navbar-expand-lg bg-warning">
    <div class="container-fluid">
        ...
        <a class="navbar-brand text-uppercase" href="#">jjc88</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <?php if (is_logged_in()) : ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="<?php echo get_url('userunfavorite.php'); ?>">Unfavorites</a>
                    </li>
                    <li class="nav-item">
                ...
                <?php if (has_role("Admin") || has_role("Moderator")) : ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" aria-current="page" href="<?php echo get_url('admin/list_currency.php'); ?>">List Currency</a>
                            </li>
                        </ul>
                    </li>
                <?php endif; ?>
